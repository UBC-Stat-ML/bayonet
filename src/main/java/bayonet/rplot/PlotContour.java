 ...
 *
 */
public class PlotContour extends RJavaBridge
{
   ...
   * @return
   */
  public static PlotContour fromFunction(MultivariateFunction f)
  {
    return new PlotContour(f);
  }
   ...
   * @param function
   */
  public PlotContour(MultivariateFunction function)
  {
  ...
  @Override public String rTemplateResourceURL() { return "/bayonet/rplot/PlotContour.txt"; }
